...
// Clutter.Color up to GNOME 46, Cogl.Color from 47: both have red, green, blue, alpha in 0-255.
const fromColor = c => ({ r: c.red, g: c.green, b: c.blue, a: c.alpha / 255 });
...
export class ThemeStyle {
    ...
    _read() {
        ...
        const fg = { ...fromColor(node.get_foreground_color()), a: 1 };
        let bg = fromColor(node.get_background_color());
        ...
        const accent = found ? { ...fromColor(selection), a: 1 } : FALLBACK_ACCENT;
